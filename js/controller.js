...
function loadCatalog(catalogName){
    ...
    $("<input>", {id: 'productAmount', class:'handleAmount', type: 'number', name: 'amount', value: '0', min: '0', max: '9'}).appendTo("#productFooter_"+i);
    ...
    if ($("#productAmount").value == "0") {
        ...
        $(".icon").addClass("valueNone")
    } else if ($("#productAmount").value > "0") {
        
    }{
        $(".icon").removeClass("valueNone")
        $(".icon").addClass("valueMore")
    }
}
